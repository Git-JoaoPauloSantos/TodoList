...
const CardTask = ({ tarefa, index, completeTask, deleteTask, fixedTask }) => {
    return (
        <Card
            sx={{
                maxWidth: 345,
            ...
            <CardActions
                ...
                <CardActions>
                    <Button
                        ...
                        color={tarefa.isFixed ? "primary" : "inherit"}
                        variant={tarefa.isFixed ? "contained" : "text"}
                        size='small'>
                        <PushPinOutlinedIcon
                            sx={{ fontSize: "1.2rem" }} />
                    </Button>
                ...
                <CardActions>
                    <Button
                        variant='outlined'
                        color={tarefa.isComplete ? "inherit" : "primary"}
